...
Examples:
    ...
    ```shell
    flask --app scripts/blueprints/_03_resources/_1_resource_folder run
    ```
    ...
    Blueprint Resource Folder:
      /workspaces/examples-py-web/packages/examples-flask/scripts/blueprints/my_first_blueprint
    style.css is:
